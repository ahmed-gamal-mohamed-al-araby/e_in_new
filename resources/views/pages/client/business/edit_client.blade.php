...
@section('title')
    @lang('site.edit') @lang('site.small_the_businessClient')
@endsection
                ...
                <div class="col-12 d-flex justify-content-between">
                    ...
                    {{-- <div class="col-sm-6 col-md-6"> --}}
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">@lang('site.small_the_businessClient') </li>
                        </ol>
                    {{-- </div> --}}
                </div>
            </div> {{-- /.end of row --}}
                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">@lang('site.edit') @lang('site.small_the_businessClient')</h3>
                        </div>
                        <main class="checkout">
                            <div class="card-data login-card">
                                <div class="row no-gutters">
                                    <div class="col-12 ">
                                        <div class="card-body">
                                            <form action="{{ route('businessClients.update', $businessClient->id) }}"
                                                    ...
                                                    <div class="row row-page">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                <select id='country_id' name="country_id"
                                                                    ...
                                                                    @foreach ($countries as $country)
                                                                        <option value='{{ $country->id }}' @if ($country->id == $businessClient->address->country->id) {{ 'selected' }} @endif>
                                                            ...
                                                            <div class="input-group mb-3">
                                                                <select id='city_id' name="city_id"
                                                                    ...
                                                                    {{-- @foreach ($cities as $city)
                                                                        <option value='{{ $country->id }}' @if ($city->id == $businessClient->address->city->id) {{ 'selected' }} @endif>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                ...
                                                                value="{{ $businessClient->address->region_city }}" placeholder="@lang('site.the_region_city')">
                                                                <div class="input-group-append">
                                                                    <span class="input-group-text">
                                                                        <i class="fas fa-building"></i></span>
                                                                </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                ...
                                                                value="{{ $businessClient->address->street }}" placeholder="@lang('site.the_street')">
                                                                <div class="input-group-append">
                                                                    <span class="input-group-text">
                                                                        <i class="fas fa-building"></i></span>
                                                                </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                ...
                                                                value="{{ $businessClient->address->building_no }}" placeholder="@lang('site.building_no')">
                                                                <div class="input-group-append">
                                                                    <span class="input-group-text">
                                                                        <i class="fas fa-building"></i></span>
                                                                </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                <input type="url" name="gmap_url"
                                                                    value="{{ $businessClient->gmap_url }}"
                                                                    class="form-control validate-url"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                <input type="text" id="company_mobile" name="mobile"
                                                                    value="{{ $businessClient->mobile }}"
                                                                    class="form-control validate-mobile"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                <input type="url" name="website_url"
                                                                    value="{{ $businessClient->website_url }}"
                                                                    class="form-control validate-url"
                                                        ...
                                                        @if ($businessClient->logo)
                                                            <div class="col-md-6">
                                                                <a class="btn btn-success mb-2" style="font-size: 12px"
                                                                    href="{{ asset("client/business/logo/$businessClient->logo") }}"
                                                                    target="_blank">@lang('site.show')
                                                                    @lang('site.businessClient_logo')</a>
                                                            </div>
                                                        @endif
                                                    </div>
                                                            ...
                                                            @foreach ($responsibePersons as $responsibePerson)
                                                                <div class="row person-row"
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="input-group mb-3">
                                                                            <input type="text"
                                                                                name="persons[0][national_id]"
                                                                                value="{{ $responsibePerson->national_id }}"
                                                                                class="form-control"
                                                                                placeholder=" @lang('site.national_id')">
                                                                            <div class="input-group-append">
                                                                                <span class="input-group-text"><i
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <textarea class="form-control" name="person_note"
                                                                        placeholder=" @lang('site.note')">{{ $businessClient->person_note }}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                <input type="text" name="tax_id_number"
                                                                    value="{{ $businessClient->tax_id_number }}"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                <input type="text" name="commercial_registeration_number"
                                                                    value="{{ $businessClient->commercial_registeration_number }}"
                                                                    class="form-control validate_commercial_registeration_number"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <label class="custom-file-label pl-5 rounded-0 m-0"
                                                                    ...
                                                                    @lang('site.choose') @lang('site.file')
                                                                    @lang('site.commercial_registeration_number_file')
                                                                </label>
                                                                <div class="input-group-append" style="z-index: 5">
                                                                    <span class="input-group-text">
                                                                        <i class="fas fa-file"></i>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                <input type="text" name="tax_file_number"
                                                                    class="form-control"
                                                                    value="{{ $businessClient->tax_file_number }}"
                                                            ...
                                                            {{-- Validation --}}
                                                            <div class="text-danger d-none mb-3">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            @if (file_exists(public_path('client/business/tax_id_number/' . $businessClient->id . '.pdf')))
                                                                <a class="btn btn-success mb-2" style="font-size: 12px"
                                                                    ...
                                                                    @lang('site.tax_id_number_file')</a>
                                                            @endif
                                                            @if (file_exists(public_path('client/business/commercial_registeration_number/' . $businessClient->id . '.pdf')))
                                                                <a class="btn btn-success mb-2" style="font-size: 12px"
                                                                    ...
                                                                    target="_blank">@lang('site.show') @lang('site.file')
                                                                    @lang('site.commercial_registeration_number_file')</a>
                                                            @endif
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <textarea class="form-control" name="accredite_note"
                                                                    placeholder=" @lang('site.note')">{{ $businessClient->accredite_note }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
@section('scripts')
    ...
    <script>
        ...
        const oldCityId = "{{ $businessClient->address->city->id}}";
        ...
        $('#country_id').trigger('change');
            ...
            $('.select-preson').on('click', '.add-new-row', function() {
                ...
                $(".select-preson .row").last().after(new_person);
    ...
    <script>
        $('.familyName_subGroup').on('change', function() {
