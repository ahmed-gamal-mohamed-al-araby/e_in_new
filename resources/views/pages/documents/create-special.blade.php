...
@section('content')
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Confirm Update available value</h5>
                ...
                <div class="modal-body">
                    {{-- <input type="hidden" name="oldqnt" id="oldqnt" value=""> --}}
                    <input type="hidden" name="available-value-modal" id="available-value-modal" value="">
                    <input type="hidden" name="updatedqnt" id="updatedqnt" value="">
                    <input type="hidden" name="itemidmodal" id="itemidmodal" value="">
                    <input type="hidden" name="itemeditIndex" id="itemeditIndex" value="">
                    هل انت متأكد من تعديل الكمية الكلية
                </div>
                <div class="modal-footer">
                    <button type="button" id="closeUpdateQnt" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button type="button" id="updateQnt" class="btn btn-success">{{ trans('site.save') }}</button>
    ...
    <section id="available-numbers" class="row my-2 dataDirection mx-1 rounded">
        <h2 class="col-md-6 textDirection py-3 d-none">{{ __('site.total') }}
            <span class="badge badge-success py-2 mx-2" id="invoice-total-span">00.00</span>
        </h2>
        <h2 class="col-md-6 textDirection py-3 d-none">
            {{ __('site.available') }}
            <span class="badge badge-success py-2 mx-2" id="available-value">00.00</span>

        </h2>
        <h2 class="col-md-12 textDirection pb-3 pt-0 text-danger d-none">
            <hr>
            {{ __('site.error') }}
            <span class="badge badge-danger mx-2 py-2" id="validation-error-message"></span>
        </h2>
    </section>
                    ...
                    <div class="fieldset-content pr-0">
                        <div class="row mb-3 ml-2">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" name="date" id="date" class="d-block"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" required name="document_number" id="document_number" class="d-block"
                                    placeholder="@lang('site.document_number')" />
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="version" class="custom-select m-0" required>
                                    ...
                                    <div class="card-body">
                                        <div class="col-md-12 mb-2">
                                            <div class="form-group ">
                                                ...
                                                <select id="from_registration_number" disabled
                                                    class="form-control require" name="company_id">
                                        ...
                                        <div class="row mb-2 mt-3">
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" value="{{ $company->tax_id_number }}"
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <input type="text" class="form control"
                                                    ...
                                                    id="from_company_name" placeholder="@lang('site.company_name')" readonly />
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-10">
                                                ...
                                                <input type="text" class="form control"
                                                    value="{{ $company->address->country->name . ' ,' . $company->address->city->name . ', ' . $company->address->region_city . ', ' . $company->address->street . ', ' . $company->address->building_no }}"
                                            ...
                                            <div class="col-md-2" id="company-id-container">
                                                ...
                                                <input type="text" id="company_id" value="{{ $company->id }}"
                                                    readonly>
                                            </div>
                                        </div>
                            ...
                            <div class="col-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="col-md-12 mb-2">
                                            <div class="form-group ">
                                                <label class="form-label" id="reg_label">@lang('site.client')</label>
                                            ...
                                            <div class="card-body p-0 client-details d-none">
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-10 document-client">
                                                        ...
                                                        <p style="line-height: 1.4rem" class="display"
                                                            id="client_address">
                                                        </p>
                                                    </div>
                                                    ...
                                                    <div class="col-md-2" id="client-id-container">
                                                        <label for="address"
                                                            class="form-label">@lang('site.id')</label>
                ...
                <fieldset>
                    <div class="row">
                        ...
                        <div class="col-6 text-right items-links">
                            <a href="#" data-toggle="modal" data-target="#addline" class="addNewItem d-none0"><i
                    ...
                    <div class="row">
                        <div class="col-4">
                            <div class="summery mt-2">
                                ...
                                <input type="number" value="0" name="extra_invoice_discount"
                                    id="invoice-discount">
                        ...
                        <div class="offset-4 col-4">
                            <div class="summery mt-2">
                                ...
                                <input type="text" disabled readonly value="" id="invoice-total-input">
                            </div>
                        </div>
                    </div>
                    ...
                    <form id="addItemsForm">
                        ...
                        <div class="row mb-2">
                            <div class="col-6">
                                ...
                                <input type="text" class="form-control" name0="product_code" id="product_code"
                                    readonly>
                            </div>
                            <div class="col-6">
                                <label>@lang('site.product_or_service')</label>
                                <input type="text" class="form-control" name0="product_name" id="product_name"
                                    readonly>
                            </div>
                        </div>
                        {{-- end of row --}}
                        ...
                        <div class="row currenty">
                            <div class="col-6">
                                ...
                                <input class="currency" id="currency" placeholder="@lang('site.currency')" readonly>
                            </div>
                            <div class="col-6">
                                <label>@lang('site.rate')</label>
                                <input class="rate" id="rate" type="number" name="curreny_rate"
                                    placeholder="@lang('site.rate')" readonly />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group md">
                                    ...
                                    <input type="number" name="discount_items_rate" id="discount_items_rate"
                                        class="discount_items_rate input-group-item" placeholder="@lang('site.discount_rate')"
                                        readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group discount-amount">
                                    ...
                                    <input type="number" name="discount_items_number" id="discount_items_number"
                                        class="discount_items_number input-group-item" placeholder="@lang('site.discount_amount')"
                                        readonly>
                                </div>
                            </div>
...
@section('scripts')
    ...
    <script src="{{ asset('invoice/8_2_2023_V1_taxitems/create-special-document.js') }}"></script>
    ...
    <script>
        ...
        $('#foreigner-client').on('change', function() {
            ...
            $.ajax({
                type: 'GET',
                url: `${subFolderURL}/${urlLang}/clients/getDocumentForeignerPurchaseOrder/` +
                    searchContent,
        ...
        // $('#item_select').select2();
        // $('#item_select').select2({
        //     placeholder: '@lang('site.choose_item') ',
        // });
        // select_purchase_order

        select2Function($('#select_purchase_order'), "@lang('site.select')");
