                                                ...
                                                @foreach ($document->items as $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @php $total_amount += ($item->quantity / ($percentage / 100)) * ($item->item_price) * $percentage / 100 @endphp
                                                            {{ $currency }} {{ number_format( ($item->quantity / ($percentage / 100)) * ($item->item_price) * $percentage / 100 , 2) }}
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
