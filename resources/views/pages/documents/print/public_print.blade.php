...
@section('content')
    ...
    <table>
        ...
        <div class="print_header">
            <img src="{{ asset('Images/public_header.png') }}" class="w-100 print_invoice_header mb-0" alt="">
            <div class="card show-one-request print" style="box-shadow: none !important">
                <div class="card-body show-request-id">
                    <div class="mb-2 public_print_invoice">
                        <div class="row my-0">
                            <div class="col-12">
                                <p class="d-inline-block">رقم الفاتوره : <span class="header_number"
                                                                               style="unicode-bidi: embed;">{{ $document->document_number }}</span>
                                </p>
                                <p class="d-inline-block mr-5">تاريخ الفاتوره : <span class="header_number"
                                                                                      style="unicode-bidi: plaintext;">{{ $document->date }}</span>
                                </p>
                            </div>
                            ...
                            <div class="col-6">
                                <div class="card card_border m-0">
                                    ...
                                    <div class="card-body"
                                        ...
                                        @else
                                            <p> <span
                                                    class="text-bold ml-2">{{ $document->purchaseOrder->businessClient->name }} </span>
                                            </p>
                                            <p> {{ $document->purchaseOrder->businessClient->tax_id_number }}<span
                                                    class="text-bold ml-3" style="padding-right:5px;">: ب.ض  </span></p>
                            ...
                            <div class="col-6">
                                <div class="card card_border" style="max-height: 100px; overflow: hidden;">
                                    ...
                                    <div class="card-header border-0">
                                        مشروع : <span>{{ $document->purchaseOrder->project_name }}</span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-5 mt-3">
                                    <table
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                @php $totalSumatiom=0; $itemRate = $document->items[0]->rate;@endphp
                                                @foreach ($document->items as $item)
                                                    @php $totalSumatiom +=$item->total_amount @endphp
                                                @endforeach
                                                {{ $currency }} {{ number_format( (($totalSumatiom / $itemRate) - $document->extra_invoice_discount) , 2) }}
                                            </th>
                                        </tr>
                                        </tbody>
                                    </table>
