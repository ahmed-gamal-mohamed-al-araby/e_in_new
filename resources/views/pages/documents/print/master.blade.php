...
<body>
    ...
    @yield('define_fraction')

    @if ($tafqeet == true)
        <script>
            const tafqeetText = $('#tafqeet');
            tafqeetText.removeClass('d-none');
            ...
            if (fraction.length == 2) {
                tafqeetText.text(tafqeet(fraction[0]) + " جنيهاً و" + tafqeet(fraction[1]) +
                    " قرشاً");
            } else if (fraction.length == 1) {
                tafqeetText.text(tafqeet(fraction[0]) + " جنيهاً");
            }
