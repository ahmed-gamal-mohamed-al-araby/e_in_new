<div class="table-responsive">
    <div class="row dataDirection">
        <div class="">
            <button id="all-documents" class="btn btn-success btn-sm m-2">@lang('site.all_documents')</button>
        </div>
        <div class="">
            <button id="sent-documents" class="btn btn-success btn-sm m-2">@lang('site.sent_documents')</button>
        </div>
        <div class="">
            <button id="received-documents" class="btn btn-success btn-sm m-2">@lang('site.received_documents')</button>
        </div>
    </div>
