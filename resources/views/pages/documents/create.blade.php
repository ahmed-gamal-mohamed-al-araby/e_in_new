                    ...
                    <div class="fieldset-content pr-0">
                        <div class="row mb-3 ml-2">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                {{-- <label for="date" class="form-label mr-3">@lang('site.date')</label> --}}
                                <input type="text" required name="document_number" id="document_number" class="d-block" placeholder="@lang('site.document_number')" />
                                ...
                                <div class="col-4">
                                    ...
                                    {{--  <div class="form-group ">  --}}
                                        <select id="select_purchase_order" name="purchase_order_id"
                                            class="form-control require select2" >
