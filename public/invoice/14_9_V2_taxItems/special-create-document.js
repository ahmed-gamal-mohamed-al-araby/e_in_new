...
function changeTableRecord(row, item) {
    row.find('.sales_amount').text(parseFloat(item.sales_amount).toLocaleString('us', { minimumFractionDigits: 2, maximumFractionDigits: 2 }));
    row.find('.discount_items_rate').text(item.discount_items_rate);
    row.find('.discount_items_number').text(parseFloat(item.discount_items_number).toLocaleString('us', { minimumFractionDigits: 2, maximumFractionDigits: 2 }));
    row.find('.taxable_fees').text(parseFloat(item.taxable_fees).toLocaleString('us', { minimumFractionDigits: 2, maximumFractionDigits: 2 }));
    row.find('.differ_value').text(parseFloat(item.differ_value).toLocaleString('us', { minimumFractionDigits: 2, maximumFractionDigits: 2 }));
    row.find('.net_total').text(parseFloat(item.net_total).toLocaleString('us', { minimumFractionDigits: 2, maximumFractionDigits: 2 }));
    row.find('.total_amount').text(parseFloat(item.total_amount).toLocaleString('us', { minimumFractionDigits: 2, maximumFractionDigits: 2 }));
}
